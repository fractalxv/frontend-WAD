...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgb(39, 39, 39) " id="navbar">
    <a class="navbar-brand" href="../index.php"><img src="https://cdn2.scratch.mit.edu/get_image/gallery/26768711_170x100.png" width="50" </a>
    ...
    <div class ="container">
      <div class="row pt-5">
        <div class="col-6 pt-5">
          <img src="../img/person/b2.JPG" class="img-thumbnail float-left" alt="Responsive image">
        </div>
        <div class="col-6 pt-5">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="embed-responsive embed-responsive-16by9">
                <img class="embed-responsive-item" src="../img/background/game1.jpg"></img>
              </div>
              <div class = "slide-right-text">
                <div class = "carousel-caption">
                  <h1>CITYLIFE<br><br></h1>
                  <h5>Genre: RPG, Adventure, Puzzle<br>
                   Video Game Requierments:<br><br>
                  </h5>
                  <p>CPU: Intel Core i5-4690 / AMD FX 4350.
RAM: 8 GB.
...
Network: Broadband Internet Connection.</p>
            ...
            <div class="carousel-item">
              <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="../img/background/game3.jpg" allowfullscreen></iframe>
              </div>
              <div class = "slide-right-text">
                <div class = "carousel-caption">
                  <h1>DOLL FRONTIER<br><br></h1>
                  <h5>Genre: First-person shooter, strategy<br>
                   Video Game Requierments:<br><br>
                  </h5>
                  <p>CPU: Intel Core i5-4690 / AMD FX 4350.
RAM: 8 GB.
...
Network: Broadband Internet Connection.
            ...
            <div class="carousel-item">
              <div class="embed-responsive embed-responsive-16by9">
                <img class="embed-responsive-item" src="../img/background/game2.jpg"></img>
              </div>
              <div class = "slide-right-text">
                <div class = "carousel-caption">
                  <h1>OPERATION DARK WINTER<br><br></h1>
                  <h5>Genre: RPG, Adventure, Puzzle<br>
                   Video Game Requierments:<br><br>
                  </h5>
                  <p>CPU: Intel Core i5-4690 / AMD FX 4350.
...
<section id="Regist">
        ...
        <div class="container" style="background-color: #ffff;">
          <div class="row text-center">
            <div class="col">
              <br></br>
              <h2>Interested to Affliate with Us?</h2>
              <br></br>
              </div>
            </div>
                ...
                <form>
                    <div class="mb-3">
                      ...
                      <label for="Nama" class="col-sm-3 col-form-label">Name</label>
                        <input type="text" class="form-control" placeholder="Nama Anda.." aria-label="Nama Anda.." aria-describedby="basic-addon1" value="">
                    </div>

                    <div class="input-group mb-3">
                      <label for="Nomor HP" class="col-sm-3 col-form-label">Email</label>
                      <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" value="">
                    </div>

                    <div class="input-group mb-3">
                      <label for="Nomor HP" class="col-sm-3 col-form-label">Questions & Suggestions&nbsp;</label>
